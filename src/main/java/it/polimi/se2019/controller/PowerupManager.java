...
public class PowerupManager {
     ...
     * @param cardIndexInHand is the index of the card in the player hand
     */
    private static void removeFromHand(Controller currentController,int cardIndexInHand,Player cardUser) {
        cardUser= currentController.getMainGameModel().getPlayerList().get(currentController.getMainGameModel().getPlayerList().indexOf(cardUser));
        cardUser.getPlayerBoard().getHand().removePowerUp(cardIndexInHand);
    }
}
