...
public class CyberBlade extends GunCardAddEff {
    ...
    public CyberBlade(){
        ...
        ammoCost[0]= 'y';
        ammoCost[1]= 'r';
        this.description ="<html>basic effect: Deal 2 damage to 1 target on your square<br>with shadowstep: Move 1 square before or after the basic effect.<br>" +
                "with slice and dice: Deal 2 damage to a different target on your square.<br>" +
                "The shadowstep may be used before or after this effect.</html>";
