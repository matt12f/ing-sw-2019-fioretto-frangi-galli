...
public class Hellion extends GunCardAltEff{
    ...
    public Hellion() {
        ...
        ammoCost[0] = 'r';
        ammoCost[1] = 'y';
        this.description = "<html>basic mode: Deal 1 damage to 1 target you can see at least<br>1 move away. Then give 1 mark to that target and everyone<br>else on that square.<br>in nano-tracer mode: Deal 1 damage to 1 target you can<br>see at least 1 move away. Then give 2 marks to that target<br>and everyone else on that square.</html>";
