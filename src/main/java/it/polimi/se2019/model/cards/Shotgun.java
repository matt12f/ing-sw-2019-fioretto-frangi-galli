...
public class Shotgun extends GunCardAltEff {
    ...
    public Shotgun() {
        ...
        ammoCost[0]= 'y';
        ammoCost[1]= 'y';
        this.description ="<html>basic mode: Deal 3 damage to 1 target on<br>your square. If you want, you may then move<br>the target 1 square.<br>in long barrel mode: Deal 2 damage to<br>1 target on any square exactly one move<br>away.</html>";
