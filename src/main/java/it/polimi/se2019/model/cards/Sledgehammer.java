...
public class Sledgehammer extends GunCardAltEff {
    ...
    public Sledgehammer() {
        ...
        ammoCost[0]= 'y';
        this.description ="<html>basic mode: Deal 2 damage to 1 target on<br>your square.<br>in pulverize mode: Deal 3 damage to 1 target<br>on your square, then move that target 0, 1,<br>or 2 squares in one direction.</html>";
