...
public class TractorBeam extends GunCardAltEff {
    ...
    public TractorBeam() {
        ...
        ammoCost[0]= 'b';
        this.description ="<html>basic mode: Move a target 0, 1, or 2 squares to a square<br> you can see, and give it 1 damage.<br>in punisher mode: Choose a target 0, 1, or 2 moves away<br>from you. Move the target to your square<br>and deal 3 damage to it.</html>";
